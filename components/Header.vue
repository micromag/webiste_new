      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="/" class="-m-1.5 p-1.5">
            ...
            <img class="h-14 w-auto" src="/public/Logo.png" alt="Logo">
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <NuxtLink to ="/Magazines" class="text-md font-semibold leading-6 text-white hover:text-blue-500">
            Magazines
          </NuxtLink>
          <NuxtLink to ="/Contribute" class="text-md font-semibold leading-6 text-white hover:text-blue-500">
            Contribute
          </NuxtLink>
                    ...
                    <div class="rounded-md bg-white shadow-xs">
                      <div class="mt-6">
                        <nav class="grid gap-y-8">
                          ...
                          <NuxtLink to="/Magazines" class="text-base font-medium text-gray-500 hover:text-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 p-3">
                            Magazines
                          </NuxtLink>
                          <NuxtLink to="/Contribute" class="text-base font-medium text-gray-500 hover:text-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 p-3">
                            Contribute
                          </NuxtLink>
